...
function gestionDe100(value,user,ServerName) {
    ...
    console.info("context1= "+Include.context1+" context2= "+Include.context2);
    if (resultat === Include.context1) {
        console.info("critique mixte ("+Include.context1+")");
        db.insert(user, "100", resultat, "mixte", ServerName);
        return resultat + "\n" + jet.mixteCritique();
    } else if (resultat === Include.context2) {
        onsole.info("critique mixte ("+Include.context2+")");
        db.insert(user, "100", resultat, "mixte", ServerName);
        return resultat + "\n" + jet.mixteCritique();
    } else if (resultat <= Include.borneReussite) {
